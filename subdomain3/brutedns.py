...
class Brutedomain:
    ...
    def check_env(self):
        if (not os.path.exists('../result/{domain}'.format(domain=self.target_domain))):
            try:
                # Note: This file is modified from the main repo.
                os.makedirs('../result/{domain}'.format(domain=self.target_domain))
    ...
    def load_cdn(self):
        cdn_set = set()
        with open('subdomain3/dict/cdn_servers.txt', 'r') as file_cdn:
    ...
    def load_nameservers(self):
        nameserver_set = set()
        with open('subdomain3/dict/name_servers.txt', 'r') as nameservers:
...
if __name__ == '__main__':
    ...
    parser.add_argument("-f1", "--sub_file",
                        help="sub dict", default='subdomain3/dict/sub_full.txt')
    parser.add_argument("-f2", "--next_sub_file",
                        help="next_sub dict", default='subdomain3/dict/next_sub_full.txt')
